                ...
                <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                    <SimpleBar style={{ height: "320px" }}>
                        ...
                        <div className="dropdown-item bg-transparent text-wrap">
                            <Link href="/" className="btn btn-soft-secondary btn-sm rounded-pill">how to setup <i
                                className="mdi mdi-magnify ms-1"></i></Link>
                            <Link href="/" className="btn btn-soft-secondary btn-sm rounded-pill">buttons <i
                                className="mdi mdi-magnify ms-1"></i></Link>
                        </div>
                    ...
                    <div className="text-center pt-3 pb-1">
                        <Link href="/pages-search-results" className="btn btn-primary btn-sm">View All Results <i
